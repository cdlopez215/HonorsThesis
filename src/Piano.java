...
public class Piano implements ActionListener {
    ...
    private String[] instruments = {"Piano", "Guitar", "Trumpet", "Choir"};
            ...
            if(numNotes < 8) {
                switch (command) {
                    case ("C5"):
                        ...
                        playFile("c4");         // Play sound file as input response
    ...
    void playFile(String note){
        try {
            String bip = instrumentInput + "_" + note + ".wav";
    ...
    public String getInstrumentInput() { return instrumentInput; }
